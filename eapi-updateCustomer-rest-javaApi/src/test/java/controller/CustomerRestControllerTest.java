...
//    }
    ...
    public void getPatienById_StatusCode400WhenargumentMismatch() throws Exception {
        ...
        mockMvc.perform(post("/v1/pharmacy/patient/update").accept(MediaType.APPLICATION_JSON_UTF8_VALUE))
    ...
    @Test
    public void getInput_StatusCode405WhenInvalidMethod() throws Exception {

        mockMvc.perform(get("/v1/pharmacy/patient/update").accept(MediaType.APPLICATION_JSON_UTF8_VALUE))
